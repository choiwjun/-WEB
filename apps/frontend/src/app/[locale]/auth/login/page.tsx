          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-end">
              <Link
                ...
                className="text-sm text-warm-gray hover:text-deep-navy"
              >
                {t('forgotPassword')}
              </Link>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-soft-white px-4 text-warm-gray">{t('socialLogin')}</span>
              </div>
            </div>
            ...
            <p className="text-center text-sm text-warm-gray mt-6">
              {t('noAccount')}{' '}
              <Link href={`/${locale}/auth/register`} className="text-deep-navy font-medium hover:underline">
